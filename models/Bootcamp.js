...
// Reverse populate with virtuals (aka virtual attributes)
BootcampSchema.virtual('courses', {
  ref: 'Course',
  localField: '_id', // the field in the Bootcamp model by that name
  foreignField: 'bootcamp', // the field in the Courses model by that name
  justOne: false, // to get an array of Courses
});
